    ...
    <section id="impact" className="section-padding bg-hope-softGray">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Impact Card 2 */}
          <div className="bg-white rounded-lg p-8 shadow-md hover:shadow-lg transition-shadow text-center animate-fade-in">
            <Counter end={120} duration={1500} suffix="+" />
            <h3 className="text-xl font-semibold mt-4 mb-2 text-hope-dark">Communities</h3>
            <p className="text-hope-dark/70">Served across the region</p>
          </div>
          ...
          {/* Impact Card 4 */}
          <div className="bg-white rounded-lg p-8 shadow-md hover:shadow-lg transition-shadow text-center animate-fade-in">
            <Counter end={350} duration={1800} suffix="+" />
