        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mb-6 text-hope-dark/80">
              HopefulHeart Foundation was established in 2015 with a single goal: to address the often-overlooked
              challenges faced by widow women in our communities. What began as a small initiative has grown into
              a movement of compassion and support.
            </p>
            <p className="mb-8 text-hope-dark/80">
              Today, we work tirelessly to ensure these resilient women have access to nutritious food, essential 
              supplies, and a supportive community that recognizes their strength and dignity.
            </p>
